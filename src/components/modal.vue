		...
		<div v-if="haswhat == 'actrule'">
			<div class="actrule">
				...
				<p>
					...
					游戏开始后，通过调整角色飞行的正确角度和喊“财神到”的声音，
					<span class="textred strong">控制角色的向上飞行。要角度准确，音量够大才能够见到财神哦，</span>
					每人每天都有三次参与机会，连续10天打卡将有惊喜彩蛋哦；
				</p>
				<p>
					<span class="strong">3.道具升级:</span>
					每天登录游戏，“见财神”道具还会升级哦！连续登录10天获得竹蜻蜓、20天获得风火轮、30天获得筋斗云；
				</p>
				<p>
					<span class="strong">4.游戏奖励:</span>
					成功见到财神后便可获得惊喜奖励，包括大吉大利财神签、楼币、超值福袋，海量楼楼周边等大波好礼；
				</p>
